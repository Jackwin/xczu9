...
set_property PACKAGE_PIN AH7  [get_ports {rgmii_td[1]}]
set_property PACKAGE_PIN AE9  [get_ports {rgmii_td[2]}]
set_property PACKAGE_PIN AD10  [get_ports {rgmii_td[3]}]

set_property PACKAGE_PIN AG9  [get_ports mdio_phy_mdc]
set_property PACKAGE_PIN AG10  [get_ports mdio_phy_mdio_io]
set_property PACKAGE_PIN AG11  [get_ports phy_resetn]
