...
#
# Generated by Vivado on Fri Jul 16 22:45:57 +0800 2021
...
#    "E:/workspace/code_repo/xczu9/source/src/tlk2711.sv"
...
#    "E:/workspace/code_repo/xczu9/source/ip/ila_emmc/ila_emmc.xci"
...
set files [list \
 ...
 [file normalize "${origin_dir}/../source/src/tlk2711.sv"] \
...
set file "$origin_dir/../source/src/tlk2711.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/../source/ip/ila_emmc/ila_emmc.xci"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../source/ip/ila_emmc/ila_emmc.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
...
proc cr_bd_mpsoc { parentCell } {
  ...
  # Create ports
  set emmc_buspow [ create_bd_port -dir O emmc_buspow ]
  set emmc_clk [ create_bd_port -dir O -type clk emmc_clk ]
  set emmc_clk_fb [ create_bd_port -dir I -type clk emmc_clk_fb ]
  set emmc_cmd_i [ create_bd_port -dir I emmc_cmd_i ]
  set emmc_cmd_o [ create_bd_port -dir O emmc_cmd_o ]
  set emmc_cmd_t [ create_bd_port -dir O emmc_cmd_t ]
  set emmc_data_i [ create_bd_port -dir I -from 7 -to 0 emmc_data_i ]
  set emmc_data_o [ create_bd_port -dir O -from 7 -to 0 emmc_data_o ]
  set emmc_data_t [ create_bd_port -dir O -from 7 -to 0 emmc_data_t ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash##Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#CAN 1#CAN 1#####I2C 0#I2C 0###########CAN 0#CAN 0#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#############Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
   CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out##n_ss_out_upper#mo_upper[0]#mo_upper[1]#mo_upper[2]#mo_upper[3]#sclk_out_upper#sdio0_data_out[0]#sdio0_data_out[1]#sdio0_data_out[2]#sdio0_data_out[3]#sdio0_data_out[4]#sdio0_data_out[5]#sdio0_data_out[6]#sdio0_data_out[7]#sdio0_cmd_out#sdio0_clk_out#sdio0_bus_pow#phy_tx#phy_rx#####scl_out#sda_out###########phy_rx#phy_tx#sdio1_wp#sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out#############rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem3_mdc#gem3_mdio_out} \
   ...
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {374.996246} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__DIVISOR0 {4} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__FREQMHZ {375} \
...
#  -string -flagsOSRD
preplace port emmc_clk_fb -pg 1 -y 360 -defaultsOSRD
preplace port emmc_clk -pg 1 -y 340 -defaultsOSRD
preplace port emmc_buspow -pg 1 -y 520 -defaultsOSRD
preplace port emmc_cmd_o -pg 1 -y 380 -defaultsOSRD
preplace port uart_0 -pg 1 -y 300 -defaultsOSRD
preplace port emmc_cmd_t -pg 1 -y 420 -defaultsOSRD
preplace port emmc_cmd_i -pg 1 -y 400 -defaultsOSRD
preplace portBus emmc_data_o -pg 1 -y 460 -defaultsOSRD
preplace portBus emmc_data_t -pg 1 -y 480 -defaultsOSRD
preplace portBus emmc_data_i -pg 1 -y 440 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -y 440 -defaultsOSRD
preplace netloc zynq_ultra_ps_e_0_UART_0 1 1 1 770J
levelinfo -pg 1 -80 550 860 -top -150 -bot 670
"
}
