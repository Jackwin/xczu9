...
proc create_root_design { parentCell } {
  ...
  set hp2 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 hp2 ]
  ...
  set fpga_mgt_aresetn [ create_bd_port -dir I -type rst fpga_mgt_aresetn ]
  set fpga_mgt_clk [ create_bd_port -dir I -type clk fpga_mgt_clk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {fpga_mgt_aresetn} \
 ] $fpga_mgt_clk
  set hp0_clk [ create_bd_port -dir I -type clk hp0_clk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {s_axi_hp0} \
 ] $hp0_clk
  set hp2_clk [ create_bd_port -dir I -type clk hp2_clk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {hp2} \
   CONFIG.FREQ_HZ {80000000} \
 ] $hp2_clk
  set i_reg_rdata [ create_bd_port -dir I -from 63 -to 0 i_reg_rdata ]
  set i_tlk2711a_loss_irq [ create_bd_port -dir I -from 0 -to 0 i_tlk2711a_loss_irq ]
  set i_tlk2711a_rx_irq [ create_bd_port -dir I -from 0 -to 0 i_tlk2711a_rx_irq ]
  set i_tlk2711a_tx_irq [ create_bd_port -dir I -from 0 -to 0 i_tlk2711a_tx_irq ]
  set i_tlk2711b_loss_irq [ create_bd_port -dir I -from 0 -to 0 i_tlk2711b_loss_irq ]
  set i_tlk2711b_rx_irq [ create_bd_port -dir I -from 0 -to 0 i_tlk2711b_rx_irq ]
  set i_tlk2711b_tx_irq [ create_bd_port -dir I -from 0 -to 0 i_tlk2711b_tx_irq ]
  set o_reg_raddr [ create_bd_port -dir O -from 31 -to 0 o_reg_raddr ]
  set o_reg_ren [ create_bd_port -dir O o_reg_ren ]
  set o_reg_waddr [ create_bd_port -dir O -from 31 -to 0 o_reg_waddr ]
  set o_reg_wdata [ create_bd_port -dir O -from 63 -to 0 o_reg_wdata ]
  set o_reg_wen [ create_bd_port -dir O o_reg_wen ]
  set phy_resetn [ create_bd_port -dir O -from 0 -to 0 phy_resetn ]
  set pl_clk0_100m [ create_bd_port -dir O -type clk pl_clk0_100m ]
  set pl_clk0_rst [ create_bd_port -dir O -from 0 -to 0 -type rst pl_clk0_rst ]
  ...
  # Create instance: fpga_mgt_1, and set properties
  set fpga_mgt_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:fpga_mgt:1.0 fpga_mgt_1 ]
  ...
  # Create instance: xlslice_78, and set properties
  set xlslice_78 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_78 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {0} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {95} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash##Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#CAN 1#CAN 1#UART 0#UART 0###I2C 0#I2C 0###########CAN 0#CAN 0##SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#############Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
   CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out##n_ss_out_upper#mo_upper[0]#mo_upper[1]#mo_upper[2]#mo_upper[3]#sclk_out_upper#sdio0_data_out[0]#sdio0_data_out[1]#sdio0_data_out[2]#sdio0_data_out[3]#sdio0_data_out[4]#sdio0_data_out[5]#sdio0_data_out[6]#sdio0_data_out[7]#sdio0_cmd_out#sdio0_clk_out#sdio0_bus_pow#phy_tx#phy_rx#rxd#txd###scl_out#sda_out###########phy_rx#phy_tx##sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out#############rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem3_mdc#gem3_mdio_out} \
   ...
   CONFIG.PSU__CRL_APB__SPI0_REF_CTRL__ACT_FREQMHZ {177.776} \
   CONFIG.PSU__CRL_APB__SPI0_REF_CTRL__DIVISOR0 {7} \
   CONFIG.PSU__CRL_APB__SPI0_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRL_APB__SPI0_REF_CTRL__FREQMHZ {200} \
   CONFIG.PSU__CRL_APB__SPI0_REF_CTRL__SRCSEL {RPLL} \
   CONFIG.PSU__CRL_APB__SPI1_REF_CTRL__ACT_FREQMHZ {177.776} \
  ...
  connect_bd_intf_net -intf_net S_AXI_HP2_FPD_0_1 [get_bd_intf_ports hp2] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP2_FPD]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports gpio] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins fpga_mgt_1/s_axi]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_interconnect_0_M00_AXI] [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_UART_1 [get_bd_intf_ports uart_0] [get_bd_intf_pins zynq_ultra_ps_e_0/UART_1]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins fpga_mgt_1/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net In0_0_1 [get_bd_ports i_tlk2711a_loss_irq] [get_bd_pins ila_0/probe3] [get_bd_pins xlconcat_2/In0]
  connect_bd_net -net In1_0_1 [get_bd_ports i_tlk2711a_rx_irq] [get_bd_pins ila_0/probe4] [get_bd_pins xlconcat_2/In1]
  connect_bd_net -net In2_0_1 [get_bd_ports i_tlk2711a_tx_irq] [get_bd_pins ila_0/probe5] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net dcm_locked_0_1 [get_bd_ports dcm_locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net fpga_mgt_1_o_reg_raddr [get_bd_ports o_reg_raddr] [get_bd_pins fpga_mgt_1/o_reg_raddr]
  connect_bd_net -net fpga_mgt_1_o_reg_ren [get_bd_ports o_reg_ren] [get_bd_pins fpga_mgt_1/o_reg_ren]
  connect_bd_net -net fpga_mgt_1_o_reg_waddr [get_bd_ports o_reg_waddr] [get_bd_pins fpga_mgt_1/o_reg_waddr]
  connect_bd_net -net fpga_mgt_1_o_reg_wdata [get_bd_ports o_reg_wdata] [get_bd_pins fpga_mgt_1/o_reg_wdata]
  connect_bd_net -net fpga_mgt_1_o_reg_wen [get_bd_ports o_reg_wen] [get_bd_pins fpga_mgt_1/o_reg_wen]
  connect_bd_net -net i_reg_rdata_1 [get_bd_ports i_reg_rdata] [get_bd_pins fpga_mgt_1/i_reg_rdata]
  connect_bd_net -net i_tlk2711_loss_1 [get_bd_ports i_tlk2711b_loss_irq] [get_bd_pins ila_0/probe0] [get_bd_pins xlconcat_3/In0]
  connect_bd_net -net i_tlk2711_rx_irq_1 [get_bd_ports i_tlk2711b_rx_irq] [get_bd_pins ila_0/probe1] [get_bd_pins xlconcat_3/In1]
  connect_bd_net -net i_tlk2711_tx_irq_1 [get_bd_ports i_tlk2711b_tx_irq] [get_bd_pins ila_0/probe2] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net proc_sys_reset_0_peripheral_reset [get_bd_ports pl_clk0_rst] [get_bd_pins proc_sys_reset_0/peripheral_reset]
  connect_bd_net -net saxihp0_fpd_aclk_0_1 [get_bd_ports hp0_clk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net saxihp2_fpd_aclk_0_1 [get_bd_ports hp2_clk] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk]
  connect_bd_net -net util_reduced_logic_1_Res [get_bd_pins util_reduced_logic_1/Res] [get_bd_pins xlconcat_1/In3]
  connect_bd_net -net util_reduced_logic_2_Res [get_bd_pins util_reduced_logic_2/Res] [get_bd_pins xlconcat_1/In2]
  ...
  connect_bd_net -net xlslice_78_Dout [get_bd_ports phy_resetn] [get_bd_pins xlslice_78/Dout]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_gpio_o [get_bd_pins xlslice_78/Din] [get_bd_pins zynq_ultra_ps_e_0/emio_gpio_o]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_ports fpga_mgt_clk] [get_bd_ports pl_clk0_100m] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins fpga_mgt_1/s_axi_aclk] [get_bd_pins ila_0/clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xB0010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xB0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs fpga_mgt_1/s_axi/reg0] SEG_fpga_mgt_1_reg0
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces s_axi_hp0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] SEG_zynq_ultra_ps_e_0_HP0_DDR_HIGH
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces s_axi_hp0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces s_axi_hp0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces s_axi_hp0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] SEG_zynq_ultra_ps_e_0_HP0_QSPI
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces hp2] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_HIGH] SEG_zynq_ultra_ps_e_0_HP2_DDR_HIGH
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces hp2] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP2_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces hp2] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP2_LPS_OCM
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces hp2] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_QSPI] SEG_zynq_ultra_ps_e_0_HP2_QSPI
