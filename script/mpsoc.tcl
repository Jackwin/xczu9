...
proc create_root_design { parentCell } {
  ...
  set tlk2711_los [ create_bd_port -dir I -from 0 -to 0 tlk2711_los ]
  set tlk2711_rx_irq [ create_bd_port -dir I -from 0 -to 0 tlk2711_rx_irq ]
  set tlk2711_tx_irq [ create_bd_port -dir I -from 0 -to 0 tlk2711_tx_irq ]
  ...
  # Create instance: fpga_mgt_0, and set properties
  set fpga_mgt_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:fpga_mgt:1.0 fpga_mgt_0 ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash##Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#CAN 1#CAN 1#####I2C 0#I2C 0###########CAN 0#CAN 0##SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
   CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out##n_ss_out_upper#mo_upper[0]#mo_upper[1]#mo_upper[2]#mo_upper[3]#sclk_out_upper#sdio0_data_out[0]#sdio0_data_out[1]#sdio0_data_out[2]#sdio0_data_out[3]#sdio0_data_out[4]#sdio0_data_out[5]#sdio0_data_out[6]#sdio0_data_out[7]#sdio0_cmd_out#sdio0_clk_out#sdio0_bus_pow#phy_tx#phy_rx#####scl_out#sda_out###########phy_rx#phy_tx##sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem3_mdc#gem3_mdio_out} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins fpga_mgt_0/s_axi]
  ...
  connect_bd_net -net In0_0_1 [get_bd_ports tlk2711_tx_irq] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net In1_0_1 [get_bd_ports tlk2711_rx_irq] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net In2_0_1 [get_bd_ports tlk2711_los] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net dcm_locked_0_1 [get_bd_ports dcm_locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net fpga_mgt_0_o_reg_raddr [get_bd_ports o_reg_raddr] [get_bd_pins fpga_mgt_0/o_reg_raddr]
  connect_bd_net -net fpga_mgt_0_o_reg_ren [get_bd_ports o_reg_ren] [get_bd_pins fpga_mgt_0/o_reg_ren]
  connect_bd_net -net fpga_mgt_0_o_reg_waddr [get_bd_ports o_reg_waddr] [get_bd_pins fpga_mgt_0/o_reg_waddr]
  connect_bd_net -net fpga_mgt_0_o_reg_wdata [get_bd_ports o_reg_wdata] [get_bd_pins fpga_mgt_0/o_reg_wdata]
  connect_bd_net -net fpga_mgt_0_o_reg_wen [get_bd_ports o_reg_wen] [get_bd_pins fpga_mgt_0/o_reg_wen]
  connect_bd_net -net i_reg_rdata_0_1 [get_bd_ports i_reg_rdata] [get_bd_pins fpga_mgt_0/i_reg_rdata]
  connect_bd_net -net s_axi_aclk_0_1 [get_bd_ports fpga_mgt_clk] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins fpga_mgt_0/s_axi_aclk]
  connect_bd_net -net s_axi_aresetn_0_1 [get_bd_ports fpga_mgt_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins fpga_mgt_0/s_axi_aresetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x000500000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs fpga_mgt_0/s_axi/reg0] SEG_fpga_mgt_0_reg0
