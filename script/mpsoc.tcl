...
proc create_root_design { parentCell } {
  ...
  set emmc [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:sdio_rtl:1.0 emmc ]
  set mido_phy [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:mdio_rtl:1.0 mido_phy ]
  set rgmii [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:rgmii_rtl:1.0 rgmii ]
  set uart_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 uart_0 ]

  # Create ports
  set i_clk_375 [ create_bd_port -dir I -type clk i_clk_375 ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {i_lock} \
   CONFIG.FREQ_HZ {375000000} \
 ] $i_clk_375
  set i_lock [ create_bd_port -dir I -type rst i_lock ]
  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_HIGH} \
 ] $i_lock
  set phy_resetn [ create_bd_port -dir O phy_resetn ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash##Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash############CAN 1#CAN 1#####I2C 0#I2C 0###########CAN 0#CAN 0##SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
   CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out##n_ss_out_upper#mo_upper[0]#mo_upper[1]#mo_upper[2]#mo_upper[3]#sclk_out_upper############phy_tx#phy_rx#####scl_out#sda_out###########phy_rx#phy_tx##sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem3_mdc#gem3_mdio_out} \
   ...
   CONFIG.PSU__SD0__GRP_POW__IO {EMIO} \
  ...
  connect_bd_intf_net -intf_net gmii_to_rgmii_0_MDIO_PHY [get_bd_intf_ports mido_phy] [get_bd_intf_pins gmii_to_rgmii_0/MDIO_PHY]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_SDIO_0 [get_bd_intf_ports emmc] [get_bd_intf_pins zynq_ultra_ps_e_0/SDIO_0]
  ...
  connect_bd_net -net clkin_0_1 [get_bd_ports i_clk_375] [get_bd_pins gmii_to_rgmii_0/clkin]
  connect_bd_net -net gmii_to_rgmii_0_mmcm_locked_out [get_bd_ports phy_resetn] [get_bd_pins gmii_to_rgmii_0/mmcm_locked_out]
  connect_bd_net -net tx_reset_0_1 [get_bd_ports i_lock] [get_bd_pins gmii_to_rgmii_0/rx_reset] [get_bd_pins gmii_to_rgmii_0/tx_reset]
